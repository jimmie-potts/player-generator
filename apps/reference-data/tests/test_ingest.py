...
import pandas as pd
import pytest
from reference_data_app.ingest import (
...
def test_aggregate_player_seasons_ignores_dnp_for_games(reference_config: dict) -> None:
    games = pd.DataFrame(
        [
            {
                "season_year": "2023-24",
    ...
    result = aggregate_player_seasons(games, reference_config)
