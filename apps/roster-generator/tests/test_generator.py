...
def _small_config(roster_config: dict) -> dict:
...
def test_generation_is_deterministic_and_has_no_reference_names(roster_config: dict) -> None:
    config = _small_config(roster_config)
